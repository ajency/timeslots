...
(function($) {
  var Timeline, addDescription, addSwipeEventHandlers, addTimeSlots, combineSlots, createChildRegion, getAllowedIntervalLabel, getCurrentTimestamp, getEndTime, getHourArray, getPixelPerSecond, getRandomColor, getStartTime, insertTimelineInterval, render, root, usedColors, validateSameDayTime, validateTimeArray;
  root = this;
  usedColors = [];
  ...
  addSwipeEventHandlers = function($parent, options) {
    ...
    return $timeslotDescription.on('swipeleft', function(e) {
      ...
      return $('.time-description.combine-parent .slot.combine-neighbour').on('tap', combineSlots.bind(this, $parent, options, slotNo));
    });
  };
