...
(function($) {
  var Timeline, addDescription, addSwipeEventHandlers, addTimeSlots, combineSlots, createChildRegion, getAllowedIntervalLabel, getCurrentTimestamp, getEndTime, getHourArray, getPixelPerSecond, getRandomColor, getStartTime, insertTimelineInterval, render, root, stopCombineSlot, usedColors, validateSameDayTime, validateTimeArray;
  root = this;
  usedColors = [];
